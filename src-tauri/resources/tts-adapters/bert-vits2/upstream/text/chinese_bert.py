...
# Prefer a model directory explicitly selected by the bilimaku adapter. This
# keeps inference local and avoids a second implicit model download.
local_model_dir = (
    os.getenv("BILIMAKU_TTS_BERT_DIR", "").strip()
    or os.getenv("BILICAST_TTS_BERT_DIR", "").strip()
)
if local_model_dir:
